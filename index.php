...
<head>
  ...
  <title>MY PerpUXtakaan-Website Daily Read Activity</title>
  <!-- loader-->
  ...
  <!--Start Dashboard Content-->
	...
	<div class="row">
     <div class="col-12 col-lg-8 col-xl-8">
	    <div class="card">
		 <div class="card-header">Book Graphics
     ...
     <div class="col-12 col-lg-4 col-xl-4">
        <div class="card">
           <div class="card-header">Book Genre Statistics
             <div class="card-action">
             <div class="dropdown">
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
              <i class="icon-options"></i>
           ...
           <div class="table-responsive">
             <table class="table align-items-center">
               <tbody>
                 <tr>
                   <td><i class="fa fa-circle text-white mr-2"></i>Sci-fi</td>
                   <td>30 books</td>
                   <td>25%</td>
                 </tr>
                 <tr>
                   <td><i class="fa fa-circle text-light-1 mr-2"></i>History</td>
                   <td>30 books</td>
                   <td>25%</td>
                 </tr>
                 <tr>
                   <td><i class="fa fa-circle text-light-2 mr-2"></i>Autobiography</td>
                   <td>30 books</td>
                   <td>25%</td>
                 </tr>
                 <tr>
                   <td><i class="fa fa-circle text-light-3 mr-2"></i>Science</td>
                   <td>30 books</td>
                   <td>25%</td>
                 </tr>
               </tbody>
