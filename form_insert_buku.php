...
<head>
  ...
  <title>Form Insert Book-MY PerpUXtakaan-Website Daily Read Activity</title>
  <!-- loader-->
        ...
        <!-- <div class="col-lg-6"> -->
          <div class="card">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-rounded" id="id_buku" name="id_buku" placeholder="Enter ID Buku">
            </div>
            <div class="form-group">
              <label for="judul" class="col-sm-2 col-form-label">Judul Buku</label>
              <input type="text" class="form-control form-control-rounded" id="judul" name="judul" placeholder="Enter Judul Buku">
            </div>
            <div class="form-group">
              <label for="penulis" class="col-sm-2 col-form-label">Penulis</label>
              <input type="text" class="form-control form-control-rounded" id="penulis" name="penulis" placeholder="Enter Penulis">
            </div>
            <div class="form-group">
              <label for="penerbit" class="col-sm-2 col-form-label">Penerbit</label>
              <input type="text" class="form-control form-control-rounded" id="penerbit" name="penerbit" placeholder="Enter Penerbit">
            </div>
            <div class="form-group">
              <label for="tahun_terbit" class="col-sm-2 col-form-label">Tahun Terbit</label>
              <input type="text" class="form-control form-control-rounded"  id="tahun_terbit" name="tahun_terbit" placeholder="Enter Tahun Terbit">
            </div>
            <div class="form-group">
              <label for="ebook" class="col-sm-2 col-form-label">Link Ebook</label>
              <input type="text" class="form-control form-control-rounded"  id="ebook" name="ebook" placeholder="Enter Link Ebook">
            </div>
            <div class="form-group">
              <label for="summary" class="col-sm-2 col-form-label">Summary</label>
              <input type="text" class="form-control form-control-rounded"  id="summary" name="summary" placeholder="Enter Summary">
            </div>
