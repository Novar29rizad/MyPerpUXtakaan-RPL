...
<head>
  ...
  <title>Form Edit-MY PerpUXtakaan-Website Daily Read Activity</title>
  <!-- loader-->
   ...
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.php">
       ...
       <h5 class="logo-text">My Perpuxtakaan Anggota</h5>
     </a>
   </div>
  ...
  <!-- TABEL  -->
          <div class="card">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-rounded" id="nama" name="nama" value="<?= $query['nama']; ?>">
            </div>
            <div class="form-group">
              <label for="peran" class="col-sm-2 col-form-label">Peran</label>
              <input type="text" class="form-control form-control-rounded" id="peran" name="peran" value="<?= $query['peran']; ?>">
            </div>
            <div class="form-group">
              <label for="nomor_telepon" class="col-sm-2 col-form-label">Nomor Telepon</label>
              <input type="text" class="form-control form-control-rounded" id="nomor_telepon" name="nomor_telepon" value="<?= $query['nomor_telepon']; ?>">
            </div>
            <div class="form-group">
              <label for="passw" class="col-sm-2 col-form-label">Passw</label>
              <input type="text" class="form-control form-control-rounded" id="passw" name="passw" value="<?= $query['passw']; ?>">
            </div>
